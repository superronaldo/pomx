          ...
          <div className="section-title-block">
            <div className="section-title-content">
              ...
              <div className="Page-description">
                <Trans>ETH is needed on Arbitrum to purchase POMX.</Trans>
                <br />
                {/* <Trans>
                  To purchase POMX on <span onClick={() => onNetworkSelect(AVALANCHE)}>Avalanche</span>, please change
                  your network.
                </Trans> */}
              </div>
            </div>
        ...
        {chainId === AVALANCHE && (
          <div className="section-title-block">
            <div className="section-title-content">
              ...
              <div className="Page-description">
                <Trans>Avax is needed on Avalanche to purchase POMX.</Trans>
                <br />
                {/* <Trans>
                  To purchase POMX on <span onClick={() => onNetworkSelect(ARBITRUM)}>Arbitrum</span>, please change your
                  network.
                </Trans> */}
              </div>
            </div>
                ...
                <div className="App-card-content no-title">
                  ...
                  <div className="direct-purchase-options">
                    <Button
                      size="xl"
                      imgSrc={gmxAvax}
                      href="https://quickswap.exchange/#/swap?swapIndex=1&currency0=ETH&currency1=0xf675Dc24f578f238E1c180E6bBbA907d1f40485b"
                    >
                      <Trans>Purchase POMX</Trans>
                    </Button>
                  </div>
                </div>
              </div>
        ...
        {chainId === ARBITRUM && (
          <div className="BuyGMXGLP-panel">
            ...
            <div className="buy-card">
              <div className="section-title-content">
                <div className="card-title">
                  <Trans>Buy POMX Bonds</Trans>
                </div>
              </div>
              <div className="App-card no-height">
                <div className="App-card-content no-title">
                  <div className="BuyGMXGLP-description">
                    <Trans>POMX bonds can be bought on Olympus Pro with a discount and a small vesting period:</Trans>
                  </div>
                  <div className="buy-gmx">
